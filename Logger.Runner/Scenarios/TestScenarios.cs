...
public static class TestScenarios
{
	...
	public static async Task<int[]> ImportantWithAllTargets(string mailgunFromDomain, string mailgunAuthValue, string testLogFilePath)
	{
		var targets = new List<ITarget> {
			new FileTarget(testLogFilePath, LogLevelEnum.Info),
			new ConsoleTarget(LogLevelEnum.Info),
		...
		return await logger.LogImportantAsync("Important message here.", extra);
	}
